...
var Input = /*#__PURE__*/function (_React$Component) {
  ...
  function Input(props) {
    ...
    _this.state = {
      ...
      inputValue: _this.props.inputValue ? _this.props.inputValue : '',
      fieldActive: false,
      inactive: _this.props.inactive !== undefined ? _this.props.inactive : false
    };
    return _this;
  }
  ...
  _createClass(Input, [{
    ...
    value: function componentDidUpdate(prevProps, prevState, snapshot) {
      if (this.props !== prevProps) {
        ...
        console.log(this.props, prevState); // TODO this can't be a good idea
    ...
    value: function render() {
      ...
      var inputClassName = (0, _classnames.default)("dev-input", {
        "field-active": this.state.fieldActive,
        "field-filled": this.state.inputValue
      }); //TODO oof

      var overallClassName = (0, _classnames.default)(this.props.className, "dev-input-top");
